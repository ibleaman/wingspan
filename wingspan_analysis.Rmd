...
font_add("bebas", "app/www/fonts/BebasNeue-Regular.ttf")
font_add("cardenio", "app/www/fonts/CardenioModern-Bold.otf")
showtext_auto()
```
...
gs_url <- "https://docs.google.com/spreadsheets/d/1-jrjGdTW_CoXiZ3QtcUCUdGj0ur-9lGbUpgIHg1zJwE/edit?usp=sharing"
...
ggplot(aes(x=game_id, y=score, color=type)) +
  # geom_col() +
  geom_line() +
  labs(title="Isaac's scores over time")
```
```{r}
data_df %>%
